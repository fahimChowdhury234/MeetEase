  ...
  <div class="h-[90vh] container  mx-auto lg:w-[1350px]" v-if="!isPreView">
    ...
    <div class="px-8 py-8 bg-white rounded-md  shadow-md mx-4  lg:w-[59%] lg:mx-0 lg:px-11 lg:py-11">
      ...
      <div class="py-3 flex justify-end mt-2">
        ...
        <button @click="send"
          class="signup flex items-center gap-1 justify-center w-32 lg:w-36 py-2 text-sm lg:text-base rounded-full font-medium border bg-prim text-white transition-all hover:bg-prim-dark active:bg-prim">
          <span>Meet Now </span>
