      ...
      <div class="bg-white rounded-md py-5 md:py-10 lg:py-16 px-7 md:px-16 w-full lg:w-5/12">
        ...
        <div class="flex md:text-lg text-base items-center mb-10 mt-2">
          ...
          <router-link to="/signup">
            <button class="text-lg font-semibold text-dh-red-400 hover:text-dh-green-900 duration-300 cursor-pointer">Create an account</button>
          </router-link>
        </div>
        <form>
          <div class="mb-7">
            <div class="flex flex-col justify-center gap-1">
              <div class="bg-[#F2F3F4] px-3.5 rounded-xl w-full" :class="isEmail ? 'error' : ''">
                <input name="email" placeholder="Email" v-model="email" type="text" class="bg-[#F2F3F4] w-full px-2 py-3.5 outline-none" value="" />
              </div>
