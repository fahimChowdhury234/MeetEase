  ...
  <div class="h-[90vh] container mx-auto lg:w-[1350px]" v-if="!show">
    <div class="flex items-center flex-col gap-5 h-full mt-4 mx-4 lg:flex-row lg:mt-0 lg:mx-0 lg:gap-0">
      <div class="w-full lg:w-1/2">
        <div class="relative">
          <div class="video border-2 border-prim-dark rounded-lg h-96" id="video" v-show="!video.mute"></div>
          <div v-show="video.mute" class="border-2 border-prim-dark bg-gray flex justify-center items-center text-white text-base rounded-lg h-96">camera is off</div>
      ...
      <div class="w-full lg:w-1/2">
        <div class="flex justify-center items-center gap-5">
          <button @click="joinRoom" class="flex items-center gap-2 h-[46px] justify-center px-10 py-2 text-base rounded-full font-medium border bg-prim text-white transition-all duration-700 hover:bg-prim-dark active:bg-prim">Join now</button>
          <button @click="close" class="flex items-center gap-2 h-[46px] justify-center px-10 py-2 text-base rounded-full font-medium border bg-gray text-white transition-all duration-700 hover:bg-opacity-20 active:bg-opacity-60">Back</button>
        </div>
      </div>
    </div>
  </div>
